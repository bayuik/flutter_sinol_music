...
class QuestionsResponse {
  ...
  QuestionsResponse({this.posts = const []});
...
class QuestionAuthorBean {
  ...
  QuestionAuthorBean({this.id, this.login, this.avatar_url, this.url, this.email
      //   this.rating
      });
...
class ReplyBean {
  ...
  ReplyBean({this.comment_ID, this.content, this.author, this.datetime
      //   this.rating
      });
