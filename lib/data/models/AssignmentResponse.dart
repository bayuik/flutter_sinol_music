...
class TranslationBean {
  ...
  factory TranslationBean.fromJson(Map<String, dynamic> json) =>
      _$TranslationBeanFromJson(json);
...
class FilesBean {
  ...
  factory FilesBean.fromJson(Map<String, dynamic> json) =>
      _$FilesBeanFromJson(json);
