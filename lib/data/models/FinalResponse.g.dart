...
CourseBean _$CourseBeanFromJson(Map<String, dynamic> json) {
  return CourseBean(
      user_course_id: json['user_course_id'] as num? ?? 0,
      user_id: json['user_id'] as num? ?? 0,
      course_id: json['course_id'] as num? ?? 0,
      current_lesson_id: json['current_lesson_id'] as num? ?? 0,
      progress_percent: json['progress_percent'] as num? ?? 0,
      status: json['status'] as String? ?? "",
      subscription_id: json['subscription_id'] as num? ?? 0,
      start_time: json['start_time'] as String? ?? "",
      lng_code: json['lng_code'] as String? ?? "",
      enterprise_id: json['enterprise_id'] as num? ?? 0,
