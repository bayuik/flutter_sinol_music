...
class AppSettings {
  ...
  AppSettings({this.addons, this.home_layout, this.options, this.demo});
...
class HomeLayoutBean {
  ...
  factory HomeLayoutBean.fromJson(Map<String, dynamic> json) =>
      _$HomeLayoutBeanFromJson(json);
...
class AddonsBean {
  ...
  AddonsBean(
      {this.shareware,
      this.sequential_drip_content,
      this.gradebook,
      this.live_streams,
      this.enterprise_courses,
      this.assignments,
      this.point_system,
      this.statistics,
      this.online_testing,
      this.course_bundle,
      this.multi_instructors});

  factory AddonsBean.fromJson(Map<String, dynamic> json) =>
      _$AddonsBeanFromJson(json);
...
class OptionsBean {
  ...
  factory OptionsBean.fromJson(Map<String, dynamic> json) =>
      _$OptionsBeanFromJson(json);
...
class ColorBean {
  ...
  factory ColorBean.fromJson(Map<String, dynamic> json) =>
      _$ColorBeanFromJson(json);
