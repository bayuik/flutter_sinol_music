...
class QuestionAddResponse {
  ...
  factory QuestionAddResponse.fromJson(Map<String, dynamic> json) =>
      _$QuestionAddResponseFromJson(json);
...
class QuestionAddBean {
  ...
  factory QuestionAddBean.fromJson(Map<String, dynamic> json) =>
      _$QuestionAddBeanFromJson(json);
...
class QuestionAddAuthorBean {
  ...
  QuestionAddAuthorBean(
      {this.id, this.login, this.avatar_url, this.url, this.email
      //   this.rating
      });
...
class ReplyAddBean {
  ...
  ReplyAddBean({this.comment_ID, this.content, this.author, this.datetime
      //   this.rating
      });
