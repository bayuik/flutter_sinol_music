      ...
      (event, emit) async {
        try {
          ...
          QuestionsResponse questionsMy =
              await _questionsRepository.getQuestions(event.lessonId,
                  event.page, event.search, currentUserId?[0] ?? "");
    ...
    on<MyQuestionAddEvent>(
      (event, emit) async {
        try {
          ...
          QuestionsResponse questionsMy = await _questionsRepository
              .getQuestions(event.lessonId, 1, "", currentUserId?[0] ?? "");
