...
class _OverviewWidgetState extends State<OverviewWidget>
      ...
      child: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            _buildReviewList(widget.reviewResponse.posts.getNonNullItems()),
          ],
        ),
      ),
    );
  ...
  _buildDescription() {
    ...
    if (descriptionHeight != null && descTextShowFlag) {
      webContainerHeight = descriptionHeight ?? 0;
    } else {
  ...
  _buildAnnoncement(String announcement) {
    ...
    if (annoncementHeight != null && annoncementTextShowFlag) {
      webContainerHeight = annoncementHeight ?? 0;
    } else {
      webContainerHeight = 160;
    }
    return Column(
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
          ConstrainedBox(
            ...
            child: WebView(
              ...
              onPageFinished: (some) async {
                double height = double.parse(await _annoncementWebViewController
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                _buildStatRow("5", (rating?.details?.five ?? 1) / onePercent,
                    rating?.details?.five),
                _buildStatRow("4", (rating?.details?.four ?? 1) / onePercent,
                    rating?.details?.four),
                _buildStatRow("3", (rating?.details?.three ?? 1) / onePercent,
                    rating?.details?.three),
                _buildStatRow("2", (rating?.details?.two ?? 1) / onePercent,
                    rating?.details?.two),
                _buildStatRow("1", (rating?.details?.one ?? 1) / onePercent,
                    rating?.details?.one),
              ],
            ),
            Column(
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        RatingBar.builder(
                          initialRating: (rating?.average ?? 0.0).toDouble(),
                          minRating: 0,
                    ...
                    children: <Widget>[
                      ...
                      Expanded(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            RatingBar.builder(
                              initialRating: (review.mark ?? 5).toDouble(),
                              minRating: 0,
                              direction: Axis.horizontal,
                              allowHalfRating: true,
                              itemCount: 5,
