...
class LessonVideoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final LessonVideoScreenArgs args =
        ModalRoute.of(context)?.settings.arguments as LessonVideoScreenArgs;
...
//regex patter to get youtube link from html text
      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              state.lessonResponse.title ?? "No Title",
              style: TextStyle(
                  fontSize: 34.0,
          ...
          state.controller == null
              ...
              : YoutubePlayer(controller: state.controller!)
        ],
      );
    }
              ...
              Expanded(
                ...
                child: Padding(
                    ...
                    child: MaterialButton(
                        ...
                        onPressed: () {
                          if (state is LoadedLessonVideoState &&
                              !(state.lessonResponse.completed ?? false)) {
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    if (state.lessonResponse.next_lesson != "") {
                      if (state.lessonResponse.next_lesson_available ?? false) {
  ...
  _buildButtonChild(LessonVideoState state) {
    ...
    if (state is LoadedLessonVideoState) {
      Widget icon;
      if ((state.lessonResponse.completed ?? false) || completed) {
