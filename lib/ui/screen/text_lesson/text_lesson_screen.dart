...
class TextLessonScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextLessonScreenArgs args =
        ModalRoute.of(context)?.settings.arguments as TextLessonScreenArgs;
                ...
                child: Padding(
                  ...
                  child: MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        } else if ((state.lessonResponse.completed ?? false) &&
