...
class AssignmentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AssignmentScreenArgs args =
        ModalRoute.of(context)?.settings.arguments as AssignmentScreenArgs;
      ...
      switch (state.assignmentResponse.status) {
        ...
        case "draft":
          return AssignmentDraftWidget(
              ...
              widget.courseId,
              widget.assignmentId,
              state.assignmentResponse.draft_id?.toInt() ?? 0);
        case "pending":
                          ...
                          case "video":
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: LessonVideoScreenArgs(
                                  widget.courseId,
                                  int.tryParse(state
                                              .assignmentResponse.prev_lesson ??
                                          "-") ??
                                      0,
                                  widget.authorAva,
                                  widget.authorName,
                          ...
                          case "video":
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: LessonVideoScreenArgs(
                                  widget.courseId,
                                  int.tryParse(state
                                              .assignmentResponse.next_lesson ??
                                          "-") ??
                                      0,
                                  widget.authorAva,
                                  widget.authorName,
            ...
            Expanded(
              ...
              child: MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    assignmentDraftWidgetState.currentState
                        ?.addAssignment(true);
                  },
                  child: (!assignmentAdd)
                      ? Text(
