...
class QuestionsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    QuestionsScreenArgs args =
        ModalRoute.of(context)?.settings.arguments as QuestionsScreenArgs;
      ...
      return TabBarView(
        children: <Widget>[
          SingleChildScrollView(
              child: ((questionsAll?.posts.length ?? 0) > 0)
                  ? Column(
                      ...
                      children: <Widget>[
                          Padding(
                            ...
                            child: _buildList(
                              questionsAll!.posts.getNonNullItems(),
                            ),
                          ),
                        ])
                  : Center(
          ...
          SingleChildScrollView(
            child: ((questionsMy?.posts.length ?? 0) > 0)
                ? Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                        Padding(
                          padding:
                              EdgeInsets.only(top: 20.0, right: 7.0, left: 7.0),
                          child: _buildMyList(
                            questionsMy!.posts.getNonNullItems(),
                          ),
                        ),
                      ])
                : Center(
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
                    ...
                    onFieldSubmitted: (text) {
                      if (questionsAll != null) {
                        _bloc.add(MyQuestionAddEvent(
                            ...
                            widget.lessonId,
                            text,
                            int.tryParse(question.comment_ID ?? '') ?? 0));
                      }
                    },
              ...
              _buildMyAnswerList((question.replies ?? []).getNonNullItems())
            ],
          ),
          Padding(
            padding: EdgeInsets.only(top: 20.0),
