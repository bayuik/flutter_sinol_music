...
class FinalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final FinalScreenArgs args =
        ModalRoute.of(context)?.settings.arguments as FinalScreenArgs;
...
class _FinalScreenState extends State<_FinalScreenWidget> {
  late FinalBloc _bloc;
  double width = 0;
  double progressWrapWidth = 0;

  @override
  void initState() {
    super.initState();
    _bloc = BlocProvider.of<FinalBloc>(context)
      ..add(FetchEvent(widget.course_id.toInt()));
  }
      ...
      return Column(
        ...
        children: <Widget>[
          Padding(
              ...
              child: Text(
                (state.finalResponse.course_completed ?? false)
          ...
          Padding(
              ...
              child: Text(
                state.finalResponse.title.toString() + "!",
                textScaleFactor: 1.0,
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontSize: 15.0,
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: _buildProgressBar(
                          state,
                          state.finalResponse.course?.progress_percent
                                  .toInt() ??
                              0)),
                ),
                Positioned(
                  ...
                  child: _buildProgressTitle(
                      state,
                      state.finalResponse.course?.progress_percent.toInt() ??
                          0),
                )
              ],
            ),
  ...
  _buildProgressTitle(LoadedFinalState state, int percent) {
    if (state.finalResponse.course_completed ?? false) {
      return Container(
          width: progressWrapWidth,
          height: 96.0,
          child: Padding(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed(
                          ...
                          arguments: ReviewWriteScreenArgs(
                              state.finalResponse.course?.course_id.toInt() ??
                                  0,
